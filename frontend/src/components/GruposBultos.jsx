...
// vez de todas iguales. Usado en el formulario unificado de Solicitud de
// Muestreo (SolicitudesMuestreoPage.jsx, "nueva" y "completar" comparten el
// mismo modal). Densidad compacta (.field-compact, ver components.css) --
// ese formulario tiene 15 campos y tiene que entrar sin scroll.
export default function GruposBultos({ grupos, onChange, disabled }) {
  ...
  return (
    <div className="field field-compact" style={{ marginBottom: '5px' }}>
      <label
        className="field-label"
        title='Si los bultos no son todos de la misma cantidad, cargalos acá en vez de (o además de) "N° de bultos" -- cada grupo imprime esa cantidad de etiquetas con su cantidad particular.'
      >
        Grupos de bultos (opcional) -- si no son todos iguales, ej. "4 x 50 kg" + "1 x 30 kg"
      </label>
      {grupos.map((g, i) => (
